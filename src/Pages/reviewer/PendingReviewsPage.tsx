...
//             student: { user: { email: 'alice.student@example.com' } },
...
//             reviewerId: '1',
//             problemId: '2',
//             studentCode: `function longestPalindrome(s) {
//     let longest = '';
...
//         let longerPalindrome = oddPalindrome.length > evenPalindrome.length ? 
...
//             student: { user: { email: 'bob.student@example.com' } },
//             reviewer: { user: { email: 'reviewer@example.com' } },
...
//                     <span>{review.student.user.email}</span>
//                   </div>
//                   <div className="flex items-center space-x-2">
...
//         title={`Review: ${selectedReview?.problem.title}`}
//         size="xl"
//       >
//         {selectedReview && (
...
//                     {selectedReview.student.user.email}
//                   </p>
